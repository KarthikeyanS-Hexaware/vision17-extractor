...
try:
 import sys
 sys.path.append("C:\\Users\\31696\\AppData\\Local\\Continuum\\Anaconda\\Lib\\site-packages")
 ...
 import argparse
     ...
     value= re.search("No module named (.*)$",str(e),re.DOTALL)
...
class ExampleHandler(FileSystemEventHandler):
    def on_created(self, event): # when file is created
           ...
           def listToString1(listData):
               return ''.join(str(e) for e in listData)
           browser = webdriver.Chrome("D:/karthi/driver/chromedriver_win32/chromedriver.exe")
           #actions= webdriver.ActionChains(browser)
           ap = argparse.ArgumentParser()
           ap.add_argument("--url", required = True,help = "Path to the url")
           args = vars(ap.parse_args())
           #url="https://www.trustpilot.com/review/squidix.com?"
           page=urllib2.urlopen(args["url"])
           browser.get(args["url"])           #print type(page)
           soup=BeautifulSoup(page,"lxml")
           file_path="C:/Users/31696/Desktop/download/review.csv"
           ...
           with open('C:/Users/31696/Desktop/review.csv', 'wb') as csvfile:
...
#                     browser.get(currenturl) 
              ...
              if(os.path.exists("C:\\Users\\31696\\Desktop\\download\\page.csv")):
                 file_path="C:\\Users\\31696\\Desktop\\download\\page.csv"
                 extracted_data= pd.read_csv(file_path,na_values=['nan'], keep_default_na=False)
                 extracted_data.columns = extracted_data.columns.str.strip()
                 ...
                 try:
                  ...
                  for m in fifth_parent:
                     ...
                     folder = 'C:/Users/31696/Desktop/download'
...
observer.schedule(event_handler, path='C:/Users/31696/Desktop/download')
observer.start()
